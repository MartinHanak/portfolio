...
export function Navbar({ languageSwitch, navbar }: Navbar) {
    ...
    return (
        <nav className={`fixed   w-full  ${display ? 'top-0' : '-top-[100%]'}  transition-all duration-1000 will-change-scroll z-[100] pointer-events-none px-2`}>
                     ...
                     " >
                        ...
                        {pageIds.map((elementID: keyof typeof navbar, index: number) => {
                            return (
                                ...
                                `}>
                                    <a className="block w-full h-full" href={`#${navbar[elementID]}`}>
